...
<body>
	<!-- Header Logo With Drop Down Menu -->
	<div class="dropdwn">
<nav>
...
<h1 align="center" class="text" style="color: #ffffff;"> Admin Login</span></b></h1>
<form style="max-width:500px;margin:auto" method="post" action="connect1.php">
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="text" placeholder="Username" name="adminname">
  </div>
  ...
  <center>
  <button type="login" class="btn" name="submit">Login</button></br></br>
  <a href="index.php"  type="button" class="button">Back To Home</a>
  </center>
</form>
</br>
</br>
